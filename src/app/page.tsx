    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6">
          ...
          <h1 className="font-sans font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[72px] uppercase leading-none tracking-tight mt-1">
            PROVEN AT THE FINISH.
          </h1>
          <p className="mt-6 font-sans text-[16px] font-light text-white/70 max-w-lg leading-relaxed">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Link
              href="/products"
              className="bg-white text-black font-sans text-[13px] font-bold uppercase tracking-widest px-8 py-3 hover:bg-white/90 transition-colors"
            >
              Shop New Arrivals
            </Link>
            <Link
              href="#signup"
              className="border border-white text-white font-sans text-[13px] font-bold uppercase tracking-widest px-8 py-3 hover:bg-white/10 transition-colors"
            >
              Join the Team
            </Link>
          </div>
      ...
      <section className="py-12 md:py-20 px-6 border-t border-white/10">
        <div className="max-w-[1440px] mx-auto max-w-3xl">
          <span className="font-mono text-[11px] tracking-[0.1em] uppercase text-white/40 block mb-4">
            FAITHFUL
          </span>
          <h2 className="font-sans font-black text-3xl md:text-5xl lg:text-6xl uppercase tracking-tight leading-none">
            HE IS THE BEGINNING // AND THE END
          </h2>
          <p className="mt-8 font-sans text-[15px] font-light text-white/70 leading-relaxed max-w-2xl">
          ...
          <blockquote className="mt-8 border-l border-white/20 pl-6 italic text-[14px] text-white/50 leading-relaxed max-w-xl">
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-white/10 p-8 md:p-12">
              ...
              <h3 className="font-sans font-black text-xl md:text-2xl uppercase tracking-tight mb-4">
                DISCIPLINE
              </h3>
              <p className="font-sans text-[14px] font-light text-white/70 leading-relaxed mb-6">
              ...
              <blockquote className="border-l border-white/20 pl-4 italic text-[13px] text-white/40 leading-relaxed">
      ...
      <section className="py-12 md:py-20 px-6 bg-gradient-to-b from-black via-gray-950 to-black">
        <div className="max-w-[1440px] mx-auto text-center">
          <span className="font-mono text-[11px] tracking-[0.1em] uppercase text-white/40 block mb-2">
            GENESIS
          </span>
          <span className="font-mono text-[11px] tracking-[0.1em] uppercase text-white/50 block mb-6">
            // LIMITED RELEASE
          </span>
          <h2 className="font-sans font-black text-4xl md:text-6xl lg:text-7xl uppercase tracking-tight leading-none">
            THE FIRST DROP
          </h2>
          <p className="mt-6 font-sans text-[15px] font-light text-white/60">
            Limited release. Built for the faithful.
          </p>
          <Link
            href="/products"
            className="inline-block mt-8 bg-white text-black font-sans text-[13px] font-bold uppercase tracking-widest px-8 py-3 hover:bg-white/90 transition-colors"
          >
            SHOP THE DROP →
          </Link>
        </div>
      ...
      <section className="py-12 md:py-20 px-6 border-t border-white/10">
        <div className="max-w-[1440px] mx-auto max-w-3xl">
          ...
          <h2 className="font-sans font-black text-3xl md:text-5xl uppercase tracking-tight leading-none mb-8">
            THIS IS MORE THAN CLOTHING.
          </h2>
          <p className="font-sans text-[15px] font-light text-white/70 leading-relaxed max-w-2xl mb-8">
          ...
          <blockquote className="border-l border-white/20 pl-6 italic text-[14px] text-white/50 leading-relaxed max-w-xl mb-10">
      ...
      {/* ━━━ EMAIL SIGNUP ━━━ */}
      <section id="signup" className="py-12 md:py-20 px-6 border-t border-white/10">
        <div className="max-w-[1440px] mx-auto max-w-xl text-center">
          <h2 className="font-sans font-black text-2xl md:text-4xl uppercase tracking-tight mb-4">
            JOIN THE STRENGTH TEAM
          </h2>
          <p className="font-sans text-[14px] italic text-white/50 mb-8">
