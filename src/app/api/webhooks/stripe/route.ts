...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  // Multi-brand guard: this Stripe account is shared across FFS storefronts and
  // client billing. Each storefront's checkout stamps metadata.source_site so
  // its own webhook fires only on its own events. Everything else (Greenstone
