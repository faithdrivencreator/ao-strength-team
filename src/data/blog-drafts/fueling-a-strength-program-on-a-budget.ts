...
const post: BlogPost = {
  slug: "fueling-a-strength-program-on-a-budget",
  title:
  ...
  body: [
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "What Every Faith-Driven Lifter Needs to Know About Strength Training Nutrition on a Budget",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Before you build your stack, hold these four variables that determine whether your nutrition plan survives the week:",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "After this guide, you'll have a concrete weekly grocery list, a protein math framework you can run in your head, and a stewardship lens for every food decision you make going forward.",
        },
      ],
    },
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "The Real Cost of Fueling a Strength Program in 2026",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1h3as", _type: "span", marks: [], text: "Why Protein Is the Only Macro Worth Targeting First" },
      ],
    },
    {
      _key: "s1p3",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1l2s", _type: "span", marks: [], text: "0.7g/lb is the evidence-based floor for natural lifters in a maintained or slight-surplus phase; 0.8g/lb adds margin for error" },
      ],
    },
    {
      _key: "s1l3",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1h3bs", _type: "span", marks: [], text: "The Stewardship Case for Budget Nutrition" },
      ],
    },
    {
      _key: "s1p4",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Building Your Weekly Grocery Stack: The Four-Tier System",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Expert tip: run the protein math before you buy anything. Multiply your bodyweight in pounds by 0.8. That is your daily protein target. Divide by the number of meals you actually eat per day. Now check whether your Tier 1 list covers it before you add a single scoop of protein powder.",
        },
      ],
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s2h3es", _type: "span", marks: [], text: "Four Practical Rules for Budget Grocery Shopping" },
      ],
    },
    {
      _key: "s2n1",
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2n3s", _type: "span", marks: [], text: "Ignore unit price obsession on everything except Tier 1 protein; a smaller bag of oats or rice is fine if it is all you need this week" }],
    },
    {
      _key: "s2n4",
      _type: "block",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "For the training program this nutrition plan is designed to fuel, see ",
        },
        {
          _key: "s2p3l",
          _type: "span",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "How Your Budget Stack Changes by Training Phase",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "The same grocery stack flexes significantly depending on whether you are trying to add mass, maintain, or lean out. The protein floor stays fixed; only carbohydrate volume and total caloric density shift.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s3h3as", _type: "span", marks: [], text: "Budget Nutrition by Body Weight" },
      ],
    },
    {
      _key: "s3p2",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s3h3bs", _type: "span", marks: [], text: "Batch Cooking the Budget Stack" },
      ],
    },
    {
      _key: "s3p3",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Stewardship Is the Theology Behind Every Grocery Trip",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s4h3s", _type: "span", marks: [], text: "Getting the Most Out of Your Budget Nutrition Plan" },
      ],
    },
    {
      _key: "s4n1",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "For the full progressive loading framework this nutrition stack is designed to support, read ",
        },
        {
          _key: "s4p2l",
          _type: "span",
          marks: ["s4p2link"],
          text: "the Faith-Driven Lifter's Guide to Progressive Overload",
        },
        {
          _key: "s4p2e",
          _type: "span",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Frequently Asked Questions About Budget Nutrition for Lifters",
        },
      ],
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q1s", _type: "span", marks: [], text: "Can I hit 180g of protein per day on a budget without protein powder?" },
      ],
    },
    {
      _key: "s5a1",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q2s", _type: "span", marks: [], text: "What is the cheapest high-protein breakfast a lifter can eat?" },
      ],
    },
    {
      _key: "s5a2",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q3s", _type: "span", marks: [], text: "How do I avoid eating the same three meals on repeat when money is tight?" },
      ],
    },
    {
      _key: "s5a3",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          _type: "span",
          marks: ["cp2link"],
          text: "read the progressive overload guide",
        },
        {
          _key: "cp2e",
          _type: "span",
