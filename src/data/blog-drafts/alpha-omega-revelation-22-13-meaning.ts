...
const post: BlogPost = {
  slug: "alpha-omega-revelation-22-13-meaning",
  title:
  ...
  body: [
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "What Every Faith-Driven Lifter Needs to Know About ‘Alpha and Omega’",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Most lifters approach the verse from one of three angles:",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Before any of those land, four things about the verse have to be true. The whole weight of the rest of this post sits on these:",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "After this guide, you will have a working theological frame for the title, a three-part identity framework you can carry under the bar, and a clear sense of why ‘Alpha and Omega’ is more useful in the gym than the verse-decoration culture has trained you to expect.",
        },
      ],
    },
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "The Theology Behind ‘Alpha and Omega’: Why It Is Not Just a Cool Name",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1h3as", _type: "span", marks: [], text: "A Claim Only One Person in History Has Ever Made" },
      ],
    },
    {
      _key: "s1p3",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "For a lifter, this is the difference between training under the eye of a powerful coach and training under the eye of the one who made the body itself. The first asks you to do better. The second knows what better is, because he wrote the design.",
        },
      ],
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1h3bs", _type: "span", marks: [], text: "The Witness of the Whole Canon" },
      ],
    },
    {
      _key: "s1p5",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "How to Read the Alpha-Omega Claim: A Three-Part Framework for the Lifter",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Three claims sit inside the title, and each one maps onto a category of the lifter’s real life. Hold these three in order. They are how the title becomes useful instead of decorative.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l1cs", _type: "span", marks: [], text: "Where it shows up: first reps of a new program, the first day after a long layoff, the decision to start at all" }],
    },
    {
      _key: "s2l1d",
      _type: "block",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "The Alpha claim disarms a quiet idolatry every lifter eventually meets: the idea that discipline is the man’s possession and not a gift. A serious training life is not something you wring out of yourself. It is something you receive, steward, and return.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l2cs", _type: "span", marks: [], text: "Where it shows up: PRs that do not come, plateaus that do not break on your timeline, the day you decide a season is over" }],
    },
    {
      _key: "s2l2d",
      _type: "block",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Most lifters under 30 train as if the program needs to climax this year. Most lifters over 40 train as if the program is closing whether they like it or not. The Omega claim corrects both. The finishing is not yours. The faithful showing up is.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l3cs", _type: "span", marks: [], text: "Where it shows up: years two through ten, the seasons no one watches, the quiet decade between getting strong and getting old" }],
    },
    {
      _key: "s2l3d",
      _type: "block",
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l3ds", _type: "span", marks: [], text: "Failure mode: training the start hard, training the end hard, and treating the middle as a holding pattern" }],
    },
    {
      _key: "s2p4",
      _type: "block",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "The middle is where most men lose their training. Not at the start, when motivation is fresh. Not at the end, when stakes are clear. In the middle, when nothing is on fire and no one is looking. The Center claim is the part of Revelation 22:13 that decides whether the training life lasts.",
        },
      ],
    },
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "What ‘Alpha and Omega’ Changes When You Step Under the Bar",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Doctrine that does not change behavior is decoration. The Alpha-Omega claim only matters here if it does work in the gym. Three concrete situations show how it does.",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Why ‘Alpha and Omega’ Is the Foundation of a Faith-Driven Training Identity",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "That is the title behind the work we publish here. Not because two Greek letters look strong in a logo. Because the One underneath them is the only one large enough to hold a training life that lasts longer than a motivational phase.",
        },
      ],
    },
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Frequently Asked Questions About ‘Alpha and Omega’ as a Lifter",
        },
      ],
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q1s", _type: "span", marks: [], text: "Where exactly does the phrase ‘Alpha and Omega’ appear in the Bible?" },
      ],
    },
    {
      _key: "s5a1",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q2s", _type: "span", marks: [], text: "Is ‘Alpha and Omega’ only about Christ, or about the Father too?" },
      ],
    },
    {
      _key: "s5a2",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q3s", _type: "span", marks: [], text: "Is it heavy-handed to bring this verse into a workout?" },
      ],
    },
    {
      _key: "s5a3",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q4s", _type: "span", marks: [], text: "How is the Alpha-and-Omega claim different from the Hebrew names of God?" },
      ],
    },
    {
      _key: "s5a4",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q5s", _type: "span", marks: [], text: "How does the cross fit with the Alpha-and-Omega claim?" },
      ],
    },
    {
      _key: "s5a5",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Revelation 22:13 is the seal on the whole canon. Twelve words. Two Greek letters. Enough to ground a man under any bar, in any season, for as long as the work is given to him. To go deeper on the practical frame underneath this, ",
        },
        {
          _key: "cp2l",
          _type: "span",
