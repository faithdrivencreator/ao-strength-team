...
const post: BlogPost = {
  slug: "first-30-days-of-strength-training",
  title:
  ...
  mainImage: {
    src: "/images/blog/first-30-days-of-strength-training/hero.webp",
    alt: "A faith-driven man standing in front of an empty barbell rack at dawn on day one of his first 30 days of strength training",
  },
  seoTitle:
    "Your First 30 Days of Strength Training: A Faith-Driven Survival Guide (2026)",
  seoDescription:
  ...
  body: [
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "What Every Faith-Driven Beginner Needs to Know About Their First 30 Days",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Your first 30 days of strength training is a defined onboarding window with one job: get a body that has never lifted under load three times a week, every week, for four straight weeks. Strength comes later. Aesthetics come later. The window's only output is a man who, on day 31, does not have to relitigate whether he is going to train this week.",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "There are five things most beginners get wrong in the first month:",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Here are the four non-negotiables a faith-driven beginner has to hold for the full thirty days:",
        },
      ],
    },
    {
    ...
    // ─── SECTION 1 — Landscape ─────────────────────────────────────────────────
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1h2s", _type: "span", marks: [], text: "The Landscape: Why Most Beginners Don't Make It to Day 31" },
      ],
    },
    {
      _key: "s1p1",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1h3as", _type: "span", marks: [], text: "What the Dropout Data Actually Says" },
      ],
    },
    {
      _key: "s1p2",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s1h3bs", _type: "span", marks: [], text: "Why Faith-Driven Lifters Have an Advantage They Rarely Use" },
      ],
    },
    {
      _key: "s1p3",
    ...
    // ─── SECTION 2 — Decision Framework ────────────────────────────────────────
    {
      ...
      markDefs: [],
      children: [
        { _key: "s2h2s", _type: "span", marks: [], text: "The 30-Day Decision Framework: One Job Per Week" },
      ],
    },
    {
      _key: "s2p1",
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l1as", _type: "span", marks: [], text: "Job: drill movement quality on squat, hinge, press, pull, carry" }],
    },
    {
      _key: "s2l1b",
      _type: "block",
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l1cs", _type: "span", marks: [], text: "Win condition: leaving every session feeling like you could have done two more sets" }],
    },
    {
      _key: "s2h3b",
      _type: "block",
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l2as", _type: "span", marks: [], text: "Job: lock the same three days and the same time slots into the week" }],
    },
    {
      _key: "s2l2b",
      _type: "block",
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l2bs", _type: "span", marks: [], text: "Load: small increase only if last week's bar speed was clean" }],
    },
    {
      _key: "s2l2c",
      _type: "block",
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l2cs", _type: "span", marks: [], text: "Win condition: three sessions completed on the calendar slots you committed to" }],
    },
    {
      _key: "s2h3c",
      _type: "block",
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l3as", _type: "span", marks: [], text: "Job: introduce real working weight on the main lift of each session" }],
    },
    {
      _key: "s2l3b",
      _type: "block",
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l3bs", _type: "span", marks: [], text: "Load: top set leaves two reps in reserve, never more, never less" }],
    },
    {
      _key: "s2l3c",
      _type: "block",
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l3cs", _type: "span", marks: [], text: "Win condition: a written log of every working set and the reps in reserve" }],
    },
    {
      _key: "s2h3d",
      _type: "block",
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l4as", _type: "span", marks: [], text: "Job: confirm the habit by training a low-motivation day and a busy-week day" }],
    },
    {
      _key: "s2l4b",
      _type: "block",
    ...
    },
    {
      ...
      level: 1,
      markDefs: [],
      children: [{ _key: "s2l4cs", _type: "span", marks: [], text: "Win condition: thirty straight days where you did not have to debate showing up" }],
    },
    {
      _key: "s2tip",
      _type: "block",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Expert tip: write the four weeks on a single piece of paper before day one and tape it inside your gym bag. Do not refine the plan during the month. The discipline of running the original plan unmodified is part of what the first 30 days are forming.",
        },
      ],
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s2h3es", _type: "span", marks: [], text: "Practical Tips: The Five Rules That Carry the Month" },
      ],
    },
    {
      _key: "s2n1",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s2h3fs", _type: "span", marks: [], text: "Full-Body Three Days vs. Body-Part Splits: Why It's Not Close" },
      ],
    },
    {
      _key: "s2p2",
    ...
    // ─── SECTION 3 — Use-Case Mapping ─────────────────────────────────────────
    {
      ...
      markDefs: [],
      children: [
        { _key: "s3h2s", _type: "span", marks: [], text: "Use-Case Mapping: Three Common Beginners, Three Adjustments" },
      ],
    },
    {
      _key: "s3p1",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "The thirty-day framework is the same for every beginner. The application changes based on where the man is starting from. Below are three real-world contexts and the small adjustments each one requires.",
        },
      ],
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s3h3as", _type: "span", marks: [], text: "The Commercial Gym Beginner" },
      ],
    },
    {
      _key: "s3p2",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s3h3bs", _type: "span", marks: [], text: "The Garage-Gym Beginner" },
      ],
    },
    {
      _key: "s3p3",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s3h3cs", _type: "span", marks: [], text: "The Traveling Beginner" },
      ],
    },
    {
      _key: "s3p4",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s3h3ds", _type: "span", marks: [], text: "Customizing the Month to Your Schedule" },
      ],
    },
    {
      _key: "s3p5",
      ...
      children: [
        ...
        },
        {
          ...
          _type: "span",
          marks: ["s3p5link"],
          text: "step into the gym as a Christian for the first time",
        },
        {
          _key: "s3p5e",
          _type: "span",
          marks: [],
          text: ", that piece pairs cleanly with this guide.",
        },
      ],
      markDefs: [
        {
          _key: "s3p5link",
          _type: "link",
          href: "/blog/beginners-guide-lifting-as-a-christian",
        },
      ],
    },
    // ─── INSTAGRAM EMBED ──────────────────────────────────────────────────────────
    ...
    // ─── SECTION 4 — Brand Value Proposition ───────────────────────────────────
    {
      ...
      markDefs: [],
      children: [
        { _key: "s4h2s", _type: "span", marks: [], text: "Why the Alpha Omega Strength Team Approach Fits a Faith-Driven First 30 Days" },
      ],
    },
    {
      _key: "s4p1",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s4h3as", _type: "span", marks: [], text: "Getting the Most Out of Your First 30 Days" },
      ],
    },
    {
      _key: "s4p2",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Pair this month with two practices and the return on every session compounds. First, read the ",
        },
        {
          _key: "s4p2l1",
          _type: "span",
          marks: ["s4p2link1"],
          text: "guide to training as worship",
        },
        {
          _key: "s4p2c",
          _type: "span",
          marks: [],
          text: " to set the doctrinal frame before week one begins. Second, install the ",
        },
        {
          _key: "s4p2l2",
          _type: "span",
          marks: ["s4p2link2"],
          text: "five-minute pre-workout prayer routine",
        },
        {
          _key: "s4p2e",
          _type: "span",
    ...
    // ─── SECTION 5 — FAQ ───────────────────────────────────────────────────────
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5h2s", _type: "span", marks: [], text: "Frequently Asked Questions About the First 30 Days" },
      ],
    },
    {
      _key: "s5q1",
      ...
      markDefs: [],
      children: [
        { _key: "s5q1s", _type: "span", marks: [], text: "How sore should I be in the first week?" },
      ],
    },
    {
      _key: "s5a1",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q2s", _type: "span", marks: [], text: "What should I eat during my first 30 days?" },
      ],
    },
    {
      _key: "s5a2",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q3s", _type: "span", marks: [], text: "What if I miss a session?" },
      ],
    },
    {
      _key: "s5a3",
    ...
    },
    {
      ...
      markDefs: [],
      children: [
        { _key: "s5q4s", _type: "span", marks: [], text: "When should I expect to see physical change?" },
      ],
    },
    {
      _key: "s5a4",
      ...
      children: [
        {
          ...
          _type: "span",
          marks: [],
          text: "Run the four weeks unmodified. Log every set. Open every session with one minute of silence and one verse. To go deeper on the discipline of progressive overload once month one is in the books, ",
        },
        {
          _key: "cp2l",
          _type: "span",
          marks: ["cp2link"],
          text: "read the progressive overload guide for faith-driven athletes",
        },
        {
          _key: "cp2e",
          _type: "span",
      ...
      markDefs: [
        {
          _key: "cp2link",
          _type: "link",
          href: "/blog/progressive-overload-for-faith-driven-athletes",
        },
      ],
    },
  ],
